...
function renderNavBar(navbarId, exampleUri) {
  ...
  const examples = [
    {
      uri: 'people_age_chart',
      name: 'Age Distribution Analysis'
    },
    {
      uri: 'people_gender_chart',
      name: 'Daily Gender Distribution Analysis'
    },
    {
      uri: 'averge_time_people_vistited',
      name: 'Visitor Time Analytics'
    },
    {
      uri: 'gender_dis_analysis',
      name: 'Gender Distribution Analysis'
    },
    {
      uri: 'age_category_chart',
      name: 'Age Categorised Chart'
    },
    // {
  ...
  githubLink.href = 'http://localhost:3000/people_age_chart'
  const h5 = document.createElement('h5')
  h5.innerHTML = 'VisitTrack'
